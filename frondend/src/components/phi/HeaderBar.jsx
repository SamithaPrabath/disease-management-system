...
import {viewReport} from '../../redux/actions/viewReport'

const HeaderBar = ({viewReport}) => {
  return (
    <div className="HeaderBar w-full min-w-[870px] h-[264px] bg-white px-[40px] py-[32px] flex flex-col gap-[10px]">
      <div className="w-full h-[160px] flex flex-row items-center justify-between border-solid border-b-[1px] border-[#E2E5E9]">
        ...
        <div className="flex gap-3">
          ...
          <button className="text-[16px] text-black font-medium bg-gray-400 px-[16px] py-[8px] rounded-[6px]">
            Un-assign Case
          </button>
      ...
      <div className="w-full h-[40px] text-[14px] px-[32px] py-[16px] flex flex-row items-center justify-center gap-[20px]">
        <p>
          <span className="text-[#65686C]">Date of Onset: </span>14/01/2025
        </p>
        <p>
          <span className="text-[#65686C]">Date of addmission: </span>14/01/2025
        </p>
        <p>
          <span className="text-[#65686C]">B.H.T Number: </span>14/01/2025
        </p>
        <p>
          <span className="text-[#65686C]">Ward: </span>14/01/2025
        </p>
      </div>
    </div>
  );
...
const mapDispatchToProps = (dispatch) => ({
    viewReport: () => dispatch(viewReport()),
  });
