...
import AddDiseases from "../../components/epidemiology/AddDiseases";
import UserTableCard from "../../components/UserTableCard";
import { connect } from "react-redux";
import EditDiseases from "../../components/epidemiology/EditDiseases";
import { getAllDiseasesData } from "../../api/diseasesApi";

const Didseaces = (props) => {
      ...
      {viewEdit ? (
        <div className="Phi w-full min-w-[870px] min-h-[500px] flex flex-col items-center justify-start gap-[32px]">
          {isOpen ? (
            ...
            <AddDiseases handleBack={handleBack} />
          )}
        </div>
      ) : (
        <EditDiseases />
...
export default connect(mapStateToProps, null)(Didseaces);
